  ...
  return <svg className={'smooth-actor-svg '+(pitcher?'pitcher':'batter')} viewBox="0 0 180 220" aria-hidden="true">
    ...
    <g ref={refs.root} className="rig-root" filter="url(#actorShadow)">
      <g className="rear-leg rig-joint" transform="translate(82 137)">
        <g ref={refs.bt} className="rig-joint"><path d="M-10 0h19l7 48-18 2-12-38z" fill="url(#jersey)" stroke="#061116" strokeWidth="5"/><path d="M-2 45h18l4 27-20 2z" fill="url(#navy)" stroke="#061116" strokeWidth="5"/><path d="M-3 71h27l4 11H-7z" fill="#071820" stroke="#061116" strokeWidth="4"/></g>
      </g>
      <g className="front-leg rig-joint" transform="translate(103 137)">
        <g ref={refs.ft} className="rig-joint"><path d="M-9 0h19l5 48-18 2-10-38z" fill="url(#jersey)" stroke="#061116" strokeWidth="5"/><path d="M-2 45h18l5 27-20 2z" fill="url(#navy)" stroke="#061116" strokeWidth="5"/><path d="M-3 71h27l4 11H-7z" fill="#071820" stroke="#061116" strokeWidth="4"/></g>
      </g>
      ...
      <g ref={refs.ba} className="rig-joint arm back-arm" transform="translate(63 86)">
        <rect x="-7" y="-2" width="15" height="42" rx="7" fill="url(#navy)" stroke="#061116" strokeWidth="4"/>
        <circle cx="1" cy="39" r="8" fill="url(#skin)" stroke="#061116" strokeWidth="4"/>
      </g>
...
export default function SmoothActor({who,stage=null,shot=null,variant='outside'}){
  const root=useRef(null),torso=useRef(null),head=useRef(null),fa=useRef(null),ba=useRef(null),ft=useRef(null),bt=useRef(null),bat=useRef(null),glove=useRef(null);
  const refs={root,torso,head,fa,ba,ft,bt,bat,glove};
  const track=useMemo(()=>{
    if(who==='pitcher'){
