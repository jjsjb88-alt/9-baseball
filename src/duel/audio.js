...
const CUES={
  ...
  grandSlam:{type:'square',gain:.064,noise:.12,noiseDur:.14,swell:.18,notes:[[72,0,.15,.68,-.2],[144,.045,.16,.78,.15],[288,.11,.19,.82,-.1],[576,.22,.26,.88,.2],[864,.42,.32,.94,-.15],[1152,.62,.34,.96,.15]]},
  ...
  battleFoul:{type:'square',gain:.038,noise:.065,noiseDur:.05,notes:[[860,0,.032,.86,.22],[1180,.045,.05,.9,-.18],[590,.10,.08,.64,.08],[760,.19,.08,.92,0]]},
