...
const MOTION={
  ...
  deadCenter:{duration:1080,impactAt:105,settleAt:760,freeze:70,slowmo:100,haptic:[18,18,38],shake:'strong'},
  solid:{duration:980,impactAt:105,settleAt:670,freeze:58,slowmo:0,haptic:[16,18,32],shake:'medium'},
  jammed:{duration:1160,impactAt:108,settleAt:820,freeze:48,slowmo:180,haptic:[12,22,18],shake:'soft'},
  ...
  out:{duration:1000,impactAt:115,settleAt:690,freeze:52,slowmo:0,haptic:[12,25,18],shake:'medium'},
  pitch:{duration:760,impactAt:100,settleAt:500,freeze:0,slowmo:0,haptic:[4],shake:'none'},
};
