...
export default function Duel(){
  ...
  const redRushEncounter=isV10&&v10Node?.opponent?.artId===RED_RUSH_ASSET_ID;
  ...
  function startPresentation(next){
    ...
    const timeline=nextNode?.opponent?.artId===RED_RUSH_ASSET_ID&&pitchJudgement?redRushTimeline(baseTimeline,reduced):baseTimeline;
