...
export default function Duel(){
  ...
  function startPresentation(next){
    const shot=presentationFor(next),reduced=next.version!==10||window.matchMedia?.('(prefers-reduced-motion: reduce)').matches,timeline=presentationTimeline(shot,reduced),pitchJudgement=!!next.battle?.revealed&&next.last?.kind!=='skill';
