...
> 사용자 피드백으로 저품질 투수 placeholder를 제거했고, 포맷이 아니라 **아트 완성도**를 게이트로 고정했다.
> 최신 시안: `dc37c69c`(마운드·릴리스·공 궤적으로 빈자리 재구성) → `cfe41b36`(디버그 라벨·카드 넘침 제거).
> D/E/F 390×844 캡처 run `35859296271` 성공, P0 무변경 검증 run `35859296273` 성공. 세 캡처를 직접 읽었다.
