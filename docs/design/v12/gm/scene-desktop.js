...
K.line(30,262,176,236,[236,226,202]);K.line(30,263,176,237,[120,80,60]);

// 2–3. opponent and duel
GM.board({x:201,y:76,w:78,h:29},{posts:14});
GM.pitcher({fx:240,fy:177,h:56,path:[276,226]});
GM.batter({x:10,y:112,h:204});
for(let k=0;k<14;k++)K.wash(0,244+k*2,170,2,[12,7,6],(k+1)/14*.9);
GM.edges(14,236,480);
